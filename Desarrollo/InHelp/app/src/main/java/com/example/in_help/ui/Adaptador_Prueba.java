...
public class Adaptador_Prueba extends BaseAdapter {
    Context context;
    List<Datos_IUGV1> ListaObjetos;

    public Adaptador_Prueba(Context context, List<Datos_IUGV1> listaObjetos) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) { // se ejecuta en cada secuencia en la que se quiera cargar el contenido de cada ito de listview
        ...
        textView.setText(ListaObjetos.get(i).getPlacas().toString());
