...
\hline
\hline
IOS & IOS es el sistema operativo movil propio de la marca creado por Steve Jobs, Apple®. & Debido a ser un software con constante actualización los requerimientos minimos serian los siguientes: \begin{UClist}
				\UCli Procesador: A7 doble nucleo a 1.3 GHz ó superior.
				\UCli RAM: 2GB ó superior
				\UCli Sistema Operativo: Android 7 Nougat ó superior
				\end{UClist} \\
\hline
\hline
...
\begin{UClist}
				\UCli Procesador: Snapdragon 425 de cuatro núcleos (1.4GHz) ó superior.
				\UCli RAM: 2GB ó superior.
				\UCli Sistema Operativo: Android 7 Nougat ó superior
				\end{UClist} \\
\hline
