...
%============================== RN8 =================================
\begin{BusinessRule}{RN8}{Numero de intentos para recuperar contraseña}
	{Restricción}
	{Controla la operación}
	\BRitem{Versión}{1.0}
	\BRitem{Autor}{Adrian Flores Torres}
	\BRitem{Estatus}{Terminada}
	\BRitem{Descripción}{El usuario solo tendrá 3 intentos para poder recuperar su contraseña, de lo contrario no se le permitirá recuperar contraseña durante los próximos 5 minutos. Cada que el usuario  inicie sesión el contador que controla el número de intentos se reiniciará a 0.}
	\BRitem{Referenciado por}{
...
%============================== RN9 =================================
\begin{BusinessRule}{RN9}{Fechas válidas}
	{Restricción}
	{Controla la operación}
	\BRitem{Versión}{1.0}
	\BRitem{Autor}{Adrian Flores Torres}
	\BRitem{Estatus}{Terminada}
	\BRitem{Descripción}{
		Para que el registro de una fecha sea válida, debe cumplir con las siguientes condiciones:
	\begin{center}
	$Fecha_{Registro} >= Fecha_{Actual}$
	\end{center}
	Donde :
	\begin{itemize}
		\item $Fecha_{Registro}$: Es la fecha que desea registrar el usuario.
		\item $Fecha_{Actual}$: Es la fecha en la que se desea realizar el regisro.
	\end{itemize}
	}
	\BRitem{Referenciado por}{
		\cdtIdRef{CUA1.3}{Recuperar cuenta}
...
%============================== RN9 =================================
\begin{BusinessRule}{RN10}{Tipo de Notificación}
	{Restricción}
	{Controla la operación}
	\BRitem{Versión}{1.0}
	\BRitem{Autor}{Adrian Flores Torres}
	\BRitem{Estatus}{Terminada}
	\BRitem{Descripción}{ La aplicación manejará tres tipos de notificaciones las cuales se describen a continuación:
		\begin{itemize}
			\item Leves : Notificaciones de bajo riesgo para el usuario.
			\item Moderadas: Notificaciones de riesgo moderado para el usuario.
			\item Altas: Notificaciones que representan peligro para el usuario.
		\end{itemize}
	}
	\BRitem{Referenciado por}{
	}
