...
\begin{figure}[htbp!]
	\begin{center}
		\fbox{\includegraphics[width=1.1\textwidth]{ModeloNegocios/images/Informacion/DG_Informacion}}
...
\begin{BusinessEntity}{Contacto}{Contacto}
	\Battr{nombre}{Nombre}{\tdCadena}{Es el nombre de pila del contacto}{\requerido}{\longitudMinMax{5}{}{30}{}}
...
\begin{BusinessEntity}{Micrófono}{Micrófono} 
	\Battr{microfono}{Nombre}{}{Es el nombre del sensor}{\requerido}
	
\end{BusinessEntity}

\begin{BusinessEntity}{Temperatura}{Temperatura} 
	\Battr{temperatura}{Nombre}{}{Es el nombre del sensor}{\requerido}
	
\end{BusinessEntity}

\begin{BusinessEntity}{Camara}{Camara} 
	\Battr{camara}{Nombre}{}{Es el nombre del sensor}{\requerido}
