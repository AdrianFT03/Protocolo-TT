...
\begin{itemize}
	...
	\item \btnVehiculos [Gestión Vehículos] : Permite al usuario acceder a la gestión de vehículos como agregar, editar, visualizar eliminar.
\end{itemize}

\IUfig[.5]{../ModeloInteraccion/imagenes/menu/MNH}{MN1}{Menú home del usuario}
...
\IUfig[.5]{../ModeloInteraccion/imagenes/menu/MNP}{MN2}{Menú principal del usuario}
