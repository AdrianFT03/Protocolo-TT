...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    ...
    \UCpaso[\UCactor] Toca el botón \cdtButton{INICIAR SESIÓN} de la pantalla \cdtIdRef{IUA-1.1}{Iniciar Sesión}. \refTray{A}
    ...
    \UCpaso[\UCsist] Pone el contador del recuperación de contraseña en 0, como lo indica la regla de negocio \cdtIdRef{RN8}{Numero de intentos para recuperar contraseña}.
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{A-1}{El usuario solicita recuperar su cuenta}
	\UCpaso[\UCactor] Toca el liga \textbf{Aquí te podemos ayudar} de la pantalla \cdtIdRef{IUA-1.1}{Iniciar Sesión}.\label{cua11:pe} 
\end{UCtrayectoriaA}
