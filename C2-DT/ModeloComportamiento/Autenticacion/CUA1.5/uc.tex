...
% %--------------------------------------------------------
    ...
    \UCitem{Entradas}{
    	\begin{UClist}
    		\UCli \cdtRef{:}{¿Tienes seguridad médica?}. \ioRadioBoton.
            \UCli \cdtRef{SeguridadSocial:no_seguridad}{Número de seguridad social}. \ioEscribir.
            \UCli \cdtRef{:}{¿Conoces tu tipo de sangre?}. \ioRadioBoton.
            \UCli \cdtRef{InfoMedica:sangre}{Grupo sanguineo}. \ioEscribir.
    	\end{UClist}
    ...
    \UCitem{Salidas}{
	\begin{UClist}
		 \UCli \cdtRef{TipoEnfermedad:nb_enfer}{Enfermedad}. \ioObtener.		
	\end{UClist}
    }
	...
	\begin{UClist}
        \UCli {\bf Interna:} Que exista información en el catálogo \cdtRef{TipoEnfermedad:nb_enfer}{Enfermedad}.
    \end{UClist}
    }
	...
	\begin{UClist}
	    \UCli {\bf Interna:} Se registrará la información médica del usuario.
	\end{UClist}
    }
    ...
    \UCitem{Tipo}{Secundario, extiende del caso de uso \cdtIdRef{CUA1.2}{Registro de cuenta}}
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    ...
    \UCpaso[\UCsist] Obtiene la informaación del catálogo \cdtRef{TipoEnfermedad:nb_enfer}{Enfermedad}.
    \UCpaso[\UCsist] Construye la pantalla \cdtIdRef{IUA1.5}{Finalizar Registro}.
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUA1.5}{Finalizar Registro}.
    \UCpaso[\UCactor] Ingresa la información del formulario de la pantalla \cdtIdRef{IUA1.5}{Finalizar Registro}. \label{cua15:tb} 
    \UCpaso[\UCactor] Presiona el botón \cdtButton{SIGUIENTE}.
