...
% %--------------------------------------------------------
    ...
    \UCitem{Propósito}{Recuperar información de la cuenta de un usuario}
    ...
    \UCitem{Salidas}{
	\begin{UClist}
        \UCli \cdtIdRef{MSG17}{Envío de correo}: Se muestra cuando se envía la contraseña.
    \end{UClist}
    }
	...
	\begin{UClist}
	    \UCli {\bf Interna:} Que el actor conozca su nombre de usuario.
        \UCli {\bf Interna:} Que el usuario se encuentre registrado.
	...
	\begin{UClist}
	    \UCli {\bf Interna:} Se enviará un correo electrónico con el mensaje \cdtIdRef{MSG15}{Recuperación de contraseña}.
	\end{UClist}
    }
    ...
    \UCitem{Reglas de negocio}{
	    ...
	    \UCli \cdtIdRef{RN8}{Numero de intentos para recuperar contraseña}: Registra el número de intentos para recuperar contraseña.
	\end{UClist}
    }
    ...
    \UCitem{Tipo}{Secundario, extiende del caso de uso \cdtIdRef{CUA1.1}{Iniciar sesión}}
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Toca el liga \textbf{Aquí te podemos ayudar} de la pantalla \cdtIdRef{IUA-1.1}{Iniciar Sesión}.
    \UCpaso[\UCsist]  Muestra la pantalla \cdtIdRef{IUA1.3}{Recuperar Cuenta}.
    \UCpaso[\UCactor] Ingresa la información del formulario de la pantalla \cdtIdRef{IUA1.3}{Recuperar Cuenta}. \label{cua13:tb} 
    \UCpaso[\UCactor] Toca el botón \cdtButton{ENVIAR} de la pantalla \cdtIdRef{IUA1.3}{Recuperar Cuenta}. \refTray{A}
    ...
    \UCpaso[\UCsist] Verifica que se pueda recuperar la contraseña para el usuario, como lo indica la regla de negocio \cdtIdRef{RN8}{Numero de intentos para recuperar contraseña}. \refTray{E}
    \UCpaso[\UCsist] Obtiene la contraseña registrada a la cuenta del usuario.\label{cua13:g1}
    \UCpaso[\UCsist] Construye el mensaje \cdtIdRef{MSG15}{Recuperación de contraseña} con los parámetros CONTRASENIA = contraseña de la cuenta del usuario.
    \UCpaso[\UCsist] Envía un correo electrónico al usuario con el mensaje \cdtIdRef{MSG15}{Recuperación de contraseña}.
    \UCpaso[\UCsist] Incrementa el contador de intentos para recuperar contraseña en 1.
    \UCpaso[\UCsist] Muestra el mensae \cdtIdRef{MSG17}{Envío de correo} en la pantalla \cdtIdRef{IUPP1A}{Pantalla Principal}.
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El usuario solicita salir de la pantalla.}
    \UCpaso[\UCactor] Toca el icono \btnRegresar de la pantalla \cdtIdRef{IUA1.3}{Recuperar Cuenta}.
	\UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUA-1.1}{Iniciar Sesión}.
 \end{UCtrayectoriaA}

 \begin{UCtrayectoriaA}[Fin del caso de uso]{A-1}{El usuario solicita salir de la pantalla}
	\UCpaso[\UCactor] Toca el icono \btnRegresar de la pantalla \cdtIdRef{IUA1.3}{Recuperar Cuenta}.
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUA-1.1}{Iniciar Sesión}.
\end{UCtrayectoriaA}

 \begin{UCtrayectoriaA}{B}{El usuario omitió un campo marcado como obligatorio.}
 	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG2}{Falta dato obligatorio} en la pantalla \cdtIdRef{IUA1.3}{Recuperar Cuenta}.
...
\end{UCtrayectoriaA}
 ...
 \begin{UCtrayectoriaA}{C}{El usuario ingreso un nombre de usuario incorrecto}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG3}{Formato de campo incorrecto} en la pantalla \cdtIdRef{IUA1.3}{Recuperar Cuenta}.
	\UCpaso[] Regresa al paso \ref{cua13:tb} de la trayectoria principal. 
\end{UCtrayectoriaA}

 \begin{UCtrayectoriaA}{D}{El usuario ingreso un nombre de usuario que no se encuentra registrado}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG5}{Usuario no registrado} en la pantalla \cdtIdRef{IUA1.3}{Recuperar Cuenta}.
	\UCpaso[] Regresa al paso \ref{cua13:tb} de la trayectoria principal. 
	
\end{UCtrayectoriaA}

 \begin{UCtrayectoriaA}{E}{El usuario excedio el número de intentos para recuperar contraseña}
    \UCpaso[\UCsist] Bloquea el envió de correos para recuperar contraseña por el tiempo definido en la regla de negocio \cdtIdRef{RN8}{Numero de intentos para recuperar contraseña}.
    \UCpaso[\UCsist] Verifica que no haya transcurrido el tiempo definido para bloqueo de envio de correos.\refTray{G-1}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG16}{Número de intentos excedido} en la pantalla \cdtIdRef{IUA1.3}{Recuperar Cuenta}.
    \UCpaso[] Regresa al paso \ref{cua13:tb} de la trayectoria principal. 
