...
% %--------------------------------------------------------
    ...
    \UCitem{Propósito}{Salir de la aplicación y así proteger los datos personales que ahí se encuentran}
    ...
    \UCitem{Salidas}{
	\begin{UClist}
		\UCli \cdtIdRef{MSG8}{Cerrar sesión}: Se muestra solicitando la confirmación del usuario para cerrar sesión.
	\end{UClist}
    }
	...
	\begin{UClist}
	    \UCli {\bf Interna:} Que la sesión se encuentre iniciada.
	\end{UClist}
    }
	...
	\begin{UClist}
	    \UCli {\bf Interna:} Se cerrará la sesión del usuario en el dispositivo.
	\end{UClist}
    }
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Toca el icono \btnCSesion del menú \cdtIdRef{MN1}{Menú home del usuario}.
    \UCpaso[\UCsist]  Muestra el mensaje \cdtIdRef{MSG8}{Cerrar sesión}.
    \UCpaso[\UCactor] Toca el botón \cdtButton{Sí quiero}. \refTray{A}
    \UCpaso[\UCsist] Cierra la sesión del usuario en el dispositivo.
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El usuario no quiere salir de la aplicación}
    \UCpaso[\UCactor] Toca el botón \cdtButton{No quiero}
