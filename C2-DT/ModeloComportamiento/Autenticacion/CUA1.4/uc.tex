...
\begin{UseCase}{CUA1.4}{Cambiar contraseña}
    {
	...
	La aplicación necesita un mecanismo de seguridad para el cambio de contraseña de un usuario, esto con la finalidad de que el usuario pueda mantener actualizada su información de la cuenta y así tener un mayor grado de seguridad. El presente caso de uso permite al usuario cambiar la contraseña que tiene registrada en la aplicación.
    }
...
% %--------------------------------------------------------
    ...
    \UCitem{Propósito}{Mantener actualizada su información de la cuenta.}
    ...
    \UCitem{Entradas}{
	\begin{UClist}
	    \UCli \cdtRef{Usuario:password}{Elige una nueva contraseña}. \ioEscribir.
        \UCli \cdtRef{Usuario:password}{Confirmar tu nueva contraseña}. \ioEscribir.
	\end{UClist}
    }
    ...
    \UCitem{Salidas}{
	\begin{UClist}
        \UCli \cdtIdRef{MSG1}{Operación realizada exitosamente}: Se muestra cuando la contraseña se cambio de forma exitosa.
    \end{UClist}
    }
	...
	\begin{UClist}
	    \UCli {\bf Interna:} Cambiará la contraseña de la cuenta del usuario.
	\end{UClist}
    }
    ...
    \UCitem{Reglas de negocio}{
        ...
        \UCli \cdtIdRef{RN6}{Formato de contraseña}: Verifica que la contraseña cumpla con el formato establecido.
	\end{UClist}
    }
	...
	\begin{UClist}
		...
		\UCli La contraseña y la confirmación de la contraseña no coinciden: La aplicación mostrará el mensaje \cdtIdRef{MSG12}{Contraseña y confirmación de contraseña erróneas}.
        \UCli La contraseña no cumple con lo establecido en la regla de negocio \cdtIdRef{RN6}{Formato de contraseña}: La aplicación mostrará el mensaje \cdtIdRef{MSG12}{Contraseña y confirmación de contraseña erróneas}.
	\end{UClist}
    }
    ...
    \UCitem{Tipo}{Secuandario, extiende del caso de uso}
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCsist]  Muestra la pantalla \cdtIdRef{IUA1.4}{Cambiar contraseña}.
    \UCpaso[\UCactor] Ingresa la información del formulario de la pantalla \cdtIdRef{IUA1.4}{Cambiar contraseña}. \label{cua14:tb} 
    \UCpaso[\UCactor] Toca el botón \cdtButton{¡LISTO!} de la pantalla \cdtIdRef{IUA1.4}{Cambiar contraseña}. \refTray{A}
    ...
    \UCpaso[\UCsist] Verifica que la información introducida en el campo \textbf{Elige una nueva contraseña} cumpla con lo estabecido en la regla de negocio \cdtIdRef{RN6}{Formato de contraseña}. \refTray{C}
    \UCpaso[\UCsist] Verifica que la información introducido en el campo \textbf{Confirma tu nueva contraseña} corresponda a la ingresada en el campo \textbf{Elige una nueva contraseña}. \refTray{D} \label{cua14:g1} 
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG1}{Operación realizada exitosamente}.
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El usuario solicita salir de la pantalla.}
    \UCpaso[\UCactor] Toca el icono \btnRegresar de la pantalla \cdtIdRef{IUA1.4}{Cambiar contraseña}.
 ...
 \begin{UCtrayectoriaA}{B}{El usuario omitió un campo marcado como obligatorio.}
 	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG2}{Falta dato obligatorio} en la pantalla \cdtIdRef{IUA1.4}{Cambiar contraseña}.
	\UCpaso[] Regresa al paso \ref{cua14:tb} de la trayectoria principal. 
	
\end{UCtrayectoriaA}


 \begin{UCtrayectoriaA}{C}{El usuario ingreso una contraseña que no cumple con lo establecido en la regla de negocio \cdtIdRef{RN6}{Formato de contraseña}.}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG12}{Contraseña y confirmación de contraseña erróneas} en la pantalla \cdtIdRef{IUA1.4}{Cambiar contraseña}.
	\UCpaso[] Regresa al paso \ref{cua14:tb} de la trayectoria principal. 
\end{UCtrayectoriaA}

 \begin{UCtrayectoriaA}{D}{El usuario ingreso una contraseña y una cnfirmación de contraseña que no coinciden.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG12}{Contraseña y confirmación de contraseña erróneas} en la pantalla \cdtIdRef{IUA1.4}{Cambiar contraseña}.
    \UCpaso[] Regresa al paso \ref{cua14:tb} de la trayectoria principal. 
\end{UCtrayectoriaA}
