...
% %--------------------------------------------------------
    ...
    \UCitem{Entradas}{
    	\begin{UClist}
            \UCli \cdtRef{Auto:no_placas}{Placas}. \ioEscribir.
    		\UCli \cdtRef{:}{¿Eres chofer o acompañante?}. \ioSeleccionar.
            \UCli \cdtRef{:}{¿Quieres darnos mas detalles?}. \ioRadioBoton.
            \UCli \cdtRef{:}{¿Tienes aseguradora?}. \ioRadioBoton.
            \UCli \cdtRef{Aseguradora:no_poliza}{No. Póliza vigente}. \ioEscribir.
            \UCli \cdtRef{Aseguradora:fh_vigencia}{¿Cual es la vigencia de tu póliza?}. \ioCalendario.
    	\end{UClist}
    ...
    \UCitem{Salidas}{
	\begin{UClist}
		 \UCli \cdtRef{:}{¿Eres chofer o acompañante?}. \ioObtener.		
	\end{UClist}
    }
	...
	\begin{UClist}
        \UCli {\bf Interna:} Que exista información en el catálogo \cdtRef{:}{¿Eres chofer o acompañante?}.
    \end{UClist}
    }
	...
	\begin{UClist}
	    \UCli {\bf Interna:} Se registrará la información del vehículo del usuario.
	\end{UClist}
    }
    %Reglas de negocio: Especifique las reglas de negocio que utiliza este caso de uso
    \UCitem{Reglas de negocio}{
    \begin{UClist}
	    \UCli \cdtIdRef{RN4}{Información Correcta}: Verifica que los campos cumplan con el formato definido.
	\end{UClist}
    }
    ...
    \UCitem{Errores}{
	\begin{UClist}
        \UCli El usuario ingreso un tipo de dato diferente al definido: La aplicación mostrará el mensaje \cdtIdRef{MSG3}{Formato de campo incorrecto}
	\end{UClist}
    }
    ...
    \UCitem{Tipo}{Secundario, extiende del caso de uso \cdtIdRef{CUA1.5}{Registro información médica}}
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Presiona el botón \cdtButton{SIGUIENTE} de la pantalla \cdtIdRef{IUA1.5}{Finalizar Registro}. \refTray{A}
    \UCpaso[\UCsist] Obtiene la información del catálogo \cdtRef{:}{¿Eres chofer o acompañante?}.
    \UCpaso[\UCsist] Construye la pantalla \cdtIdRef{IUA1.5A}{Finalizar Registro}.
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUA1.5A}{Finalizar Registro}.
    \UCpaso[\UCactor] Ingresa la información del formulario de la pantalla \cdtIdRef{IUA1.5A}{Finalizar Registro}. \label{cua15:tb} 
    \UCpaso[\UCactor] Presiona el botón \cdtButton{SIGUIENTE}. \refTray{B} \label{cua16:pe}
    \UCpaso[\UCsist] Verifica que el usuario haya introducido información en el formulario.
    \UCpaso[\UCsist] Verifica que la información introducida sea correcta como lo establece la regla de negocio \cdtIdRef{RN4}{Información Correcta}.
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El usuario solicita salir de la pantalla.}
    \UCpaso[\UCactor] Toca el icono \btnRegresar de la pantalla \cdtIdRef{IUA1.5A}{Finalizar Registro}. 
	\UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUA1.5}{Finalizar Registro}.
 \end{UCtrayectoriaA}

  \begin{UCtrayectoriaA}[Fin del caso de uso]{B}{El usuario solicita omitir el ingreso de esta información.}

    \UCpaso[\UCactor] Toca la liga OMITIR de la pantalla \cdtIdRef{IUA1.5A}{Finalizar Registro}.\label{cua16:pe1} 
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUA1.5C}{Finalizar Registro}.
 \end{UCtrayectoriaA}


 \begin{UCtrayectoriaA}{C}{El usuario ingreso un campo incorrecto}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG3}{Formato de campo incorrecto} en la pantalla \cdtIdRef{IUA1.5A}{Finalizar Registro}
