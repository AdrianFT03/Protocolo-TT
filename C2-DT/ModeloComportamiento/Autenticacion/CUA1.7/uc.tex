...
\begin{UseCase}{CUA1.5}{Registrar contactos}
    {
	...
	EL registro de contactos podría considerarse la información mas importante para In-Help ya que los contactos que tenga registrados el usuario, serán a los mismos que se les enviarán notificaciones en caso de que llegara a presentarse un posible evento correspondiente a un percanse automovilístico.
    }
...
% %--------------------------------------------------------
    ...
    \UCitem{Entradas}{
    	\begin{UClist}
            \UCli \cdtRef{:}{Contactos}. \ioCheckBox.
    	\end{UClist}
	...
	\begin{UClist}
        \UCli {\bf Interna:} Que el usuario tenga contactos dregistrados en el dispositivo.
    \end{UClist}
    }
	...
	\begin{UClist}
	    \UCli {\bf Interna:} Se registrará la información de los contactos seleccionados por el usuario.
        \UCli {\bf Interna:} La cuenta del usuario cambiará a estado \textbf{Activa} como lo indica el \hyperlink{cv:Cuenta}{Modelo del ciclo de vida de una cuenta}.
	\end{UClist}
    }
	...
	\UCitem{Maquinas de estado}{
	 \begin{UClist}
        \UCli \hyperlink{cv:Cuenta}{Modelo del ciclo de vida de una cuenta}: Cambia a estado \textbf{Activa} la cuenta del usaurio.
    \end{UClist}
	}
    ...
    \UCitem{Tipo}{Cuaternario, extiende del caso de uso \cdtIdRef{CUA1.6}{Registro información de vehículo}}
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Presiona el botón \cdtButton{SIGUIENTE} de la pantalla \cdtIdRef{IUA1.5A}{Finalizar Registro}. 
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUA1.5C}{Finalizar Registro}.  \label{cua17:tc}
    \UCpaso[\UCactor] Presiona el botón \cdtButton{SIGUIENTE}.\refTray{A} \refTray{B} 
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUA1.6}{Registrar Contactos}.
    \UCpaso[\UCactor] Selecciona los contacots que desea registrar.
    \UCpaso[\UCactor] Presiona el botón \cdtButton{¡LISTO!}. \refTray{C} 
    \UCpaso[\UCsist] Registra la información de los contactos con tipo Familiar.
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUA1.7}{Registro Finalizado}. \label{cua17:tb}
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El usuario solicita salir de la pantalla.}
    \UCpaso[\UCactor] Toca el icono \btnRegresar de la pantalla \cdtIdRef{IUA1.5C}{Finalizar Registro}. 
	\UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUA1.5A}{Finalizar Registro}.
 \end{UCtrayectoriaA}

  \begin{UCtrayectoriaA}[Fin del caso de uso]{B}{El usuario solicita omitir el ingreso de esta información.}

    \UCpaso[\UCactor] Toca la liga OMITIR de la pantalla \cdtIdRef{IUA1.5C}{Finalizar Registro}.\label{cua16:pe1} 
    \UCpaso[\UCsist] Regresa al paso \ref{cua17:tb} de la yrayectoria principal.
 \end{UCtrayectoriaA}


 \begin{UCtrayectoriaA}{C}{El usuario solicita salir de la pantalla.}
    \UCpaso[\UCactor] Toca el icono \btnRegresar de la pantalla \cdtIdRef{IUA1.6}{Registrar Contactos}.
	\UCpaso[] Regresa al paso \ref{cua17:tc} de la trayectoria principal.  
\end{UCtrayectoriaA}
