...
\begin{UseCase}{CUGN6}{Gestionar configuracion de notificación}
    {
	   La configuración de notificaciones permite al usuario poder definir que información y a que contactos se enviará la información que el usuario tiene registrada. El presente caso de uso permite al usuario visualizar los contactos que tiene registrados para poder configurar las notificaciones que se enviarán en caso del registro de un evento.
    }
...
% %--------------------------------------------------------
    ...
    \UCitem{Propósito}{Acceder a la configuración de notificaciones.}
    ...
    \UCitem{Entradas}{
	\begin{UClist}
		\UCli \cdtRef{:}{Placas}. \ioObtener.
		\UCli \cdtRef{:}{Contacto}. \ioObtener.
	\end{UClist}
    }
    ...
    \UCitem{Precondiciones}{
		\begin{UClist}
		\UCli {\bf Interna:} Que el usuario tenga contactos registrados.
	\end{UClist}
    }
    ...
    \UCitem{Errores}{
	\begin{UClist}
		\UCli \cdtIdRef{MS20}{Sin información}. Se muestra cuando no existen vehículos registrados.
	\end{UClist}
    }
    ...
    \UCitem{Tipo}{Secundario, extiende del caso de uso \cdtIdRef{CUGN5}{Configurar notificaciones}.}
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Toca el icono \btnDetalle de la pantalla \cdtIdRef{IUGN5}{Configurar Notificaciones}.
    \UCpaso[\UCsist] Obtiene  la información de la pantalla \cdtIdRef{IUGN6}{Configurar Notificación}, la cual se establece en la sección de salidas del presente caso de uso. \refTray{A}
    \UCpaso[\UCsist] Construye la pantalla con la información obtenida en el paso anterior.
    \UCpaso[\UCsist]  Muestra la pantalla \cdtIdRef{IUGN6}{Configurar Notificación}.
    \UCpaso[\UCactor] Visualiza las información de la pantalla.
    \UCpaso[\UCactor] Gestiona por medio del icono \btnOn, \btnGestionar. \label{cugn6:pe}
    
   
 \end{UCtrayectoria}

 \begin{UCtrayectoriaA}[Fin del caso de uso]{A}{No existen vehículos registrados en la aplicación.}
 	\UCpaso[\UCsist] Construye el mensaje \cdtIdRef{MS20}{Sin información} con el parámetro ELEMENTO = contactos.
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MS20}{Sin información}.
\end{UCtrayectoriaA}
...
\UCExtensionPoint
{El actor solicita configurar la información de las notificaciones.}
{ Paso \ref{cugn6:pe} de la Trayectoria Principal}
{\cdtIdRef{CUGN8}{Configurar información de notificación}}

\UCExtensionPoint
{El actor solicita activar un contacto.}
{ Paso \ref{cugn6:pe} de la Trayectoria Principal}
{\cdtIdRef{CUGN7}{Activar contacto}}
