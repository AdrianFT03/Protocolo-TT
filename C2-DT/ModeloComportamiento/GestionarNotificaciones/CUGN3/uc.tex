...
% %--------------------------------------------------------
    ...
    \UCitem{Entradas}{
	\begin{UClist}
		\UCli \cdtRef{:}{Nombre de la aseguradora}. \ioObtener.
		\UCli \cdtRef{:}{Número de teléfono}. \ioObtener.
		\UCli \cdtRef{:}{No.Póliza}. \ioObtener.
		\UCli \cdtRef{:}{Fecha de vigencia}. \ioObtener.
		\UCli \cdtRef{:}{GPS}. \ioObtener.
		\UCli \cdtRef{:}{Velocidad}. \ioObtener.
		\UCli \cdtRef{:}{Temperatura}. \ioObtener.
		\UCli \cdtRef{:}{Giroscopio}. \ioObtener.
		\UCli \cdtRef{:}{Tipo de sangre}. \ioObtener.
		\UCli \cdtRef{:}{Enfermedad}. \ioObtener.
\end{UClist}
    ...
    \UCitem{Tipo}{Terciario, extiende del caso de uso \cdtIdRef{CUGN2}{VisualizariInformación de notificación}}
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor]  Toca el icono \btnDetalles de la pantalla \cdtIdRef{IUGN2}{Información de Notificación}.
  	\UCpaso[\UCsist]Obtiene la información establecida en la sección de salidas del presente caso de uso.
    \UCpaso[\UCsist] Muestra la pantalla  \cdtIdRef{IUGN3}{Información General}.
