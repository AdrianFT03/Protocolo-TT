...
% %--------------------------------------------------------
    ...
    \UCitem{Propósito}{Consultar la información de una notificación.}
    ...
    \UCitem{Entradas}{
	\begin{UClist}
		\UCli Pantalla \cdtIdRef{IUGN2}{Información de Notificación}.
		\begin{itemize}
			\item \cdtRef{:}{Placas}. \ioObtener.
			\item \cdtRef{:}{Tipo de evento}. \ioObtener.
			\item \cdtRef{:}{Fecha de evento}. \ioObtener.
			\item \cdtRef{:}{Fecha de notificación}. \ioObtener.
			\item \cdtRef{:}{Ubicación}. \ioObtener.
		\end{itemize}
		
		\UCli Pantalla \cdtIdRef{IUGN2A}{Información de Notificación}.
	\begin{itemize}
		\item \cdtRef{:}{Nombre}. (Nombre, Primer Apellido, Segundo Apellido) \ioObtener.
		\item \cdtRef{:}{Vehículo}. \ioObtener.
		\item \cdtRef{:}{Tipo de evento}. \ioObtener.
		\item \cdtRef{:}{Fecha de evento}. \ioObtener.
		\item \cdtRef{:}{Fecha de notificación}. \ioObtener.
		\item \cdtRef{:}{Ubicación}. \ioObtener.
...
\end{UClist}
    ...
    \UCitem{Tipo}{Secundario, extiende del caso de uso \cdtIdRef{CUGN1}{Gestionar notificaciones}}
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor]  Toca el icono \btnDetalle de la pantalla \cdtIdRef{IUGN1}{Gestión de Notificaciones}. \refTray{A}
    \UCpaso[\UCsist] Obtiene la información establecida en la sección de salidas del presente caso de uso para la pantalla \cdtIdRef{IUGN2}{Información de Notificación}.
    \UCpaso[\UCsist] Muestra la pantalla  \cdtIdRef{IUGN2}{Información de Notificación}.
    \UCpaso[\UCactor] Visualiza la información de la pantalla. \label{cugn2:ta} 
    \UCpaso[\UCactor] Presiona el icono \btnDetalles. \refTray{B}
    \UCpaso[\UCsist] Ejecuta el caso de uso \cdtIdRef{CUGN3}{Visualizar detalle de información}.\label{cugn2:pe}

 \end{UCtrayectoria}

\begin{UCtrayectoriaA}{A}{El usuario actor presiona el icono \btnDetalle de la pantalla \cdtIdRef{IUGN1}{Gestión de Notificaciones}. }
    \UCpaso[\UCsist] Muestra la pantalla  \cdtIdRef{IUGN2A}{Información de Notificación}.
	\UCpaso[\UCsist] Regresa al paso \ref{cugn2:ta} de la trayectoria principal.
\end{UCtrayectoriaA}


\begin{UCtrayectoriaA}[Fin del caso de uso]{B}{El usuario actor solicita salir de la pantalla.}
...
{\cdtIdRef{CUGN3}{Visualizar detalle de información}}
