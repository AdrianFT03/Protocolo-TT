...
\begin{UseCase}{CUGN7}{Activar contacto}
    {
	   La configuración de notificaciones permite al usuario poder definir que información y a que contactos se enviará la información que el usuario tiene registrada. El presente caso de uso permite al usuario seleccionar los contactos a los que se enviarán notificaciones en caso de que un evento sea registrado en In-Help.
    }
...
% %--------------------------------------------------------
    ...
    \UCitem{Propósito}{Definir los contactos }
    ...
    \UCitem{Entradas}{
	\begin{UClist}
		\UCli \cdtRef{:}{Estado activo/inactivo}. \ioObtener.
	\end{UClist}
    }
    ...
    \UCitem{Postcondiciones}{
		\begin{UClist}
		\UCli {\bf Interna:} Cambiará la bandera que identifica si se notificara en caso de un evento del contacto para el coche que se este configurando.
	\end{UClist}
    }
    ...
    \UCitem{Tipo}{Terciario, extiende del caso de uso \cdtIdRef{CUGN6}{Gestionar configuracion de notificación}.}
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Toca el \btnOn de la pantalla \cdtIdRef{IUGN6}{Configurar Notificación}.
    
    \UCpaso[\UCsist] Cambia la bandera del contacto para la notificación del vehículo seleccionado.
