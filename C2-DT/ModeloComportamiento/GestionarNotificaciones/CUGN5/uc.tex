...
\begin{UseCase}{CUGN1}{Gestionar notificaciones}
    {
	   Las notificaciones son el envió en información a contactos registrados y autorizados por el usuario. El usuario necesita un mecanismo para visualizar las notificaciones que han sido enviadas, así como la información que se envió en las mismas. El presente caso de uso permite al usuario gestionar las notificaciones que se han generado por medio de In-Help.
    }
...
% %--------------------------------------------------------
    ...
    \UCitem{Propósito}{Consultar las notificaciones que se han enviado previamente}
    ...
    \UCitem{Entradas}{
	\begin{UClist}
		\UCli \cdtIdRef{IUGN1}{Gestión de Notificaciones}.
		\begin{itemize}
			\item \cdtRef{:}{Placas}. \ioObtener.
			\item \cdtRef{:}{Fecha de generación}. \ioObtener.
		\end{itemize}
		\UCli \cdtIdRef{IUGN1A}{Gestión de Notificaciones}.
		\begin{itemize}
			\item \cdtRef{:}{Nombre}. (Nombre, Primer Apellido, Segundo Apellido). \ioObtener.
			\item \cdtRef{:}{Fecha de generación}. \ioObtener.
		\end{itemize}
	\end{UClist}
    }
    ...
    \UCitem{Precondiciones}{
		\begin{UClist}
		\UCli {\bf Interna:} Que el usuario tenga notificaciones asociadas.
	\end{UClist}
    }
    ...
    \UCitem{Reglas de negocio}{
    	\begin{UClist}
    		\UCli \cdtIdRef{RN10}{Tipo de Notificación}. Obtiene el tipo de notificación.
    	\end{UClist}
    }
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Presiona la opción \textbf{¡Notificaciones!} del menú \cdtIdRef{MN2}{Menú principal del usuario}
    \UCpaso[\UCsist] Obtiene  la información de la pantalla \cdtIdRef{IUGN1}{Gestión de Notificaciones}, la cual se establece en la sección de salidas del presente caso de uso.
    \UCpaso[\UCsist] Construye la pantalla con la información obtenida en el paso anterior.
    \UCpaso[\UCsist]  Muestra la pantalla \cdtIdRef{IUGN1}{Gestión de Notificaciones}.
    \UCpaso[\UCactor] Visualiza las información de la pantalla. \refTray{A}
    \UCpaso[\UCactor] Gestiona por medio del icono \btnDetalle. \label{cugn1:pe}
    
   
 \end{UCtrayectoria}


 \begin{UCtrayectoriaA}{A}{El usuario actor solicita gestionar las notificaciones de sus contatos.}
	\UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUGN1A}{Gestión de Notificaciones}.
	\UCpaso[] Regresa al paso\ref{cugn1:pe} de la trayectoria principal. 
\end{UCtrayectoriaA}

\subsection{Puntos de extensión}

\UCExtensionPoint
{El actor desea ver la información de la notificación.}
{ Paso \ref{cugn1:pe} de la Trayectoria Principal}
{\cdtIdRef{CUGN2}{Visualizar información de notificación}}
