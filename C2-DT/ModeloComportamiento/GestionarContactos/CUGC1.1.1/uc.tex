...
\begin{UseCase}{CUGC1.1.1}{Visualizar información de contacto}
    {
	  	La aplicación necesita un mecanismo para visualizar  la información de los contactos que tiene registrado el usuario. El presente caso de uso permite al usuario visualizar la información con la que fue registrado alguno de los contactos que tiene asociados.
    }
...
\end{UClist}
	...
	\begin{UClist}
			\UCli \cdtRef{:}{Parentesco}. \ioObtener.
			\UCli \cdtRef{Contacto:telefonoc}{Número de teléfono}. \ioObtener.
			\UCli \cdtIdRef{MSG18}{Información contacto}. Se muestra  en la pantalla con la información del contacto.
	\end{UClist}
    }
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    ...
    \UCpaso[\UCsist] Construye el mensaje \cdtIdRef{MSG18}{Información contacto} con la información obtenida en el paso anterior.
    \UCpaso[\UCactor] Presiona el botón \cdtButton{Aceptar}.
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUGC1.1}{Contactos Registrados}.
