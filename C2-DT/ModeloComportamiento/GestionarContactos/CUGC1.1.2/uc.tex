...
\begin{UseCase}{CUGC1.1.2}{Eliminar contacto}
    {
	  	La aplicación necesita un mecanismo para eliminar  la información de los contactos que tiene registrado el usuario. El presente caso de uso permite al usuario eliminar la información con la que fue registrado alguno de los contactos que tiene asociados.
    }
...
% %--------------------------------------------------------
    ...
    \UCitem{Propósito}{Mostrar la información de los contactos registrados por el usuario.}
    ...
    \UCitem{Entradas}{
	\begin{UClist}
	\UCli \cdtRef{:}{Parentesco}. \ioObtener.
	\UCli \cdtRef{Contacto:telefonoc}{Número de teléfono}. \ioObtener.
\end{UClist}
	...
	\begin{UClist}
			\UCli \cdtRef{:}{Parentesco}. \ioObtener.
			\UCli \cdtRef{Contacto:telefonoc}{Número de teléfono}. \ioObtener.
			\UCli \cdtIdRef{MSG19}{Eliminar elemento}. Se muestra  en la pantalla solicitando la confirmación del usuario.
	\end{UClist}
    }
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor]  Toca el icono \btnContacto de la pantalla \cdtIdRef{IUGC1.1}{Contactos Registrados}.
    \UCpaso[\UCsist] Obtiene la información establecida en la sección de salidas del presente caso de uso.
    \UCpaso[\UCsist] Construye el mensaje \cdtIdRef{MSG19}{Eliminar elemento} con los parámetros  ARTICULO = el , ELEMENTO = contacto , SELECCIÓN = seleccionado.
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG19}{Eliminar elemento}.
    \UCpaso[\UCactor] Presiona el botón \cdtButton{Sí}. \refTray{A}
    \UCpaso[\UCsist] Elimina la información del contacto seleccionado.
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUGC1.1}{Contactos Registrados}. \label{cugc112}
    
 \end{UCtrayectoria}



\begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El usuario solicita cancelar la operación.}
	\UCpaso[\UCactor] Toca el botón \cdtButton{No} del mensaje \cdtIdRef{MSG19}{Eliminar elemento}.
	\UCpaso[\UCactor]  Regresa al paso \ref{cugc112} de la trayectoria principal.
\end{UCtrayectoriaA}
