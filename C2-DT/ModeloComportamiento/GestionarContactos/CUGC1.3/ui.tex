...
\subsubsection{Comandos}
    \begin{itemize}
    	...
    	\begin{itemize}
            ...
            \item [Emergencia]: Permite al actor acceder al registro de un contacto de Emergencia, dirige a la pantalla \cdtIdRef{IUGC1.3}{Registrar Contacto}.
            \item [Aseguradora]: Permite al actor acceder al registro de un contacto de Aseguradora, dirige a la pantalla \cdtIdRef{IUGC1.3A}{Registrar Contacto}.
            \item [Familiar]: Permite al actor acceder al registro de un contacto Familiar, dirige a la pantalla \cdtIdRef{IUGC1.3B}{Registrar Contacto}.
    	\end{itemize}
