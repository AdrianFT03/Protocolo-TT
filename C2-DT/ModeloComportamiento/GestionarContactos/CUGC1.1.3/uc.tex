...
% %--------------------------------------------------------
    ...
    \UCitem{Propósito}{Proporcionar mecanismo para edición de usuarios}
    ...
    \UCitem{Entradas}{
    	\begin{UClist}
    		\UCli Pantalla \cdtIdRef{IUGC1.1.3}{Editar Contacto}.
    		\begin{itemize}
    		...
    		\end{itemize}
            \UCli Pantalla \cdtIdRef{IUGC1.1.3A}{Editar Contacto}.
            \begin{itemize}
            ...
            \end{itemize}
            \UCli Pantalla \cdtIdRef{IUGC1.1.3B}{Editar Contacto}.
            \begin{itemize}
                \item \cdtRef{Contacto:nombrec}{Nombre}. \ioEscribir.
	...
	\begin{UClist}
		\UCli Pantalla \cdtIdRef{IUGC1.1.3}{Editar Contacto}.
		\begin{itemize}
			\item \cdtRef{Contacto:nombrec}{Nombre}. \ioObtener.
			\item \cdtRef{Contacto:pri_apec}{Primer apellido}. \ioObtener.
			\item \cdtRef{Contacto:seg_apec}{Segundo apellido}. \ioObtener.
			\item \cdtRef{Contacto:telefonoc}{Número de teléfono}. \ioObtener.
		\end{itemize}
		\UCli Pantalla \cdtIdRef{IUGC1.1.3A}{Editar Contacto}.
		\begin{itemize}
			\item \cdtRef{Contacto:nombrec}{Nombre de la aseguradora}. \ioObtener.
			\item \cdtRef{Contacto:telefonoc}{Número de teléfono}. \ioObtener.
			\item \cdtRef{Aseguradora:no_poliza}{No. de póliza}. \ioObtener.
			\item  \cdtRef{Aseguradora:fh_vigencia}{Fecha de vigencia}. \ioObtener.
		\end{itemize}
		\UCli Pantalla \cdtIdRef{IUGC1.1.3B}{Editar Contacto}.
		\begin{itemize}
			\item \cdtRef{Contacto:nombrec}{Nombre}. \ioObtener.
			...
			\item \cdtRef{Contacto:telefonoc}{Número de teléfono}. \ioObtener.
		\end{itemize}
	\UCli \cdtIdRef{MSG1}{Operación realizada exitosamente}. Se muestra cuando se guarda la información del usuario correctamente.
	\end{UClist}
	...
	\begin{UClist}
	    \UCli {\bf Interna:} Se actualizará la información del contacto.
	\end{UClist}
    }
	...
	\begin{UClist}
        ...
        \UCli El usuario ingreso un dato incorrecto: La aplicación mostrará el mensaje \cdtIdRef{MSG3}{Formato de campo incorrecto}.
	\end{UClist}
    }
    ...
    \UCitem{Tipo}{Terciario, extiende del caso de uso \cdtIdRef{CUGC1.1}{Gestionar contactos registrados}.}
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Toca el icono \btnGestionar de la pantalla \cdtIdRef{IUGC1.1}{Contactos Registrados}.
    
    \UCpaso[\UCsist]  Muestra la pantalla \cdtIdRef{IUGC1.1.3}{Editar Contacto}.
    
    \UCpaso[\UCactor] Ingresa la información del formulario de la pantalla \cdtIdRef{IUGC1.1.3}{Editar Contacto}. \label{cugc113:tb} 
    
    \UCpaso[\UCactor] Toca el botón \cdtButton{GUARDAR} de la pantalla \cdtIdRef{IUGC1.1.3}{Editar Contacto}. \refTray{A} \refTray{B} \refTray{C}


    \UCpaso[\UCsist] Verifica que los campos obligatorios no se omitan, como lo indica la regla de negocio \cdtIdRef{RN1}{Campos obligatorios}. \refTray{D}
    \UCpaso[\UCsist] Verifica que el la información introducida sea correcta, como lo indica la regla de negocio \cdtIdRef{RN4}{Información Correcta}. \refTray{E}
 ...
 \begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El usuario solicita salir de la pantalla.}
    \UCpaso[\UCactor] Toca el icono \btnRegresar de la pantalla \cdtIdRef{IUGC1.1.3}{Editar Contacto}.
	\UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUGC1.1}{Gestión de Contactos Registrados}.
 \end{UCtrayectoriaA}

  \begin{UCtrayectoriaA}[Fin del caso de uso]{B}{El usuario desea registrar un contacto de aseuradora.}
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUGC1.1.3A}{Editar Contacto}.
    \UCpaso[\UCsist] Regresa al paso \ref{cugc113:tb} de la trayectoria principal.
 \end{UCtrayectoriaA}

  \begin{UCtrayectoriaA}[Fin del caso de uso]{C}{El usuario desea registrar un contacto de emergencia.}
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUGC1.3B}{Editar Contacto}.
    \UCpaso[\UCsist] Regresa al paso \ref{cugc113:tb} de la trayectoria principal.
 \end{UCtrayectoriaA}


 \begin{UCtrayectoriaA}{D}{El usuario omitió un campo marcado como obligatorio.}
 	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG2}{Falta dato obligatorio} en la pantalla \cdtIdRef{IUGC1.1.3}{Editar Contacto}.
...
\end{UCtrayectoriaA}
 ...
 \begin{UCtrayectoriaA}{E}{El usuario ingreso un dato incorrecto}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG3}{Formato de campo incorrecto}.
	\UCpaso[] Regresa al paso \ref{cugc113:tb} de la trayectoria principal. 
