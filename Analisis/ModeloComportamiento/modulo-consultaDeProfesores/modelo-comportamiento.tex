\chapter{Modelo de comportamiento módulo de Consulta de Profesores}

En este capítulo se describen los casos de uso referentes a las acciones que puede realizar el usuario en el modulo de consulta de profesores. \bigskip
    ...
    \end{objetivos}
 	...
 	\cfinput{ModeloComportamiento/modulo-consultaDeProfesores/cucp1/uc}
 	\cfinput{ModeloComportamiento/modulo-consultaDeProfesores/cucp1_1/uc}
 	\cfinput{ModeloComportamiento/modulo-consultaDeProfesores/cucp1_2/uc}